...
// Breif discription of this project :-
/*
* A Glove that can speak out for dumb people for communication purpose, this glove can be handwarable.
* Each sensor is placed on each fingures to measure the bent value of fingures and send it to arduino uno.
* Depending on input from sensors arduino uno sends the correspounding data to speaker as output for this project. 
*/

//Required Components for this project :-
/*
 * Flex Sensors(Analog outputs) - 5
 * Arduino UNO(Analog pins are used)
 * Speaker(5W)
 * 10k resistors
 * We use Talkie library for arduino to speak
 */

/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
                                                      /*Sign language Glove - CODE*/
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*1*/const float flatResistance1 = 70000.0; // resistance when flat
/*1*/const float bendResistance1 = 130000.0;  // resistance at 90 deg
int flag1;

const int flexpin2 = A2;
/*2*/const float flatResistance2 = 55000.0; // resistance when flat
/*2*/const float bendResistance2 = 100000.0;  // resistance at 90 deg
int flag2;

const int flexpin3 = A1;
/*3*/const float flatResistance3 = 40000.0; // resistance when flat
/*3*/const float bendResistance3 = 100000.0;  // resistance at 90 deg
int flag3;

const int flexpin4 = A0;
/*4*/const float flatResistance4 = 45000.0; // resistance when flat
/*4*/const float bendResistance4 = 120000.0;  // resistance at 90 deg
int flag4;
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("|------------------------------------|");
  Serial.println("|    This is Sign Language Glove     |");
  Serial.println("|------------------------------------|");
}
...
void loop() {
  ...
  // Output Depending on Code Sequence
  ...
  if(flag1==1 && flag2==1 && flag3==0 && flag4==1){
    audio.say(spTHAT_IS_RIGHT);
  }
  if(flag1==1 && flag2==1 && flag3==1 && flag4==0){
    audio.say(spTHAT_IS_INCORRECT);
  }
